"""Evaluate the saved ItemOnlyLightGCN checkpoint against validation interactions."""
...
def run_item_only_evaluation(config: dict) -> dict:
...
def main() -> None:
    args = parse_args()
    print(json.dumps(run_item_only_evaluation(load_config(args.config)), indent=2, sort_keys=True))
